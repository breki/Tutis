    ...
    public class WikiTextTokenizer : IWikiTextTokenizer
    {
        ...
        private static List<WikiTextTokenDef> PrepareTokens ()
        {
            ...
            var def = new List<WikiTextTokenDef>
            {
                ...
                new WikiTextTokenDef("''", false, WikiTextToken.TokenType.DoubleApostrophe, WikiTextTokenScopes.LineStart | WikiTextTokenScopes.InnerText | WikiTextTokenScopes.HeadingText | WikiTextTokenScopes.ExternalLinkText, ModifyScopeForAnywhereTokens),
                new WikiTextTokenDef("'''", false, WikiTextToken.TokenType.TripleApostrophe, WikiTextTokenScopes.LineStart | WikiTextTokenScopes.InnerText | WikiTextTokenScopes.HeadingText | WikiTextTokenScopes.ExternalLinkText, ModifyScopeForAnywhereTokens),
                new WikiTextTokenDef("=", false, WikiTextToken.TokenType.Heading1Start, WikiTextTokenScopes.LineStart, x => x | WikiTextTokenScopes.HeadingText),
                new WikiTextTokenDef("=", false, WikiTextToken.TokenType.Heading1End, WikiTextTokenScopes.HeadingText, x => (x | WikiTextTokenScopes.HeadingSuffix) & ~WikiTextTokenScopes.HeadingText),
                new WikiTextTokenDef("==", false, WikiTextToken.TokenType.Heading2Start, WikiTextTokenScopes.LineStart, x => x | WikiTextTokenScopes.HeadingText),
                new WikiTextTokenDef("==", false, WikiTextToken.TokenType.Heading2End, WikiTextTokenScopes.HeadingText, x => (x | WikiTextTokenScopes.HeadingSuffix) & ~WikiTextTokenScopes.HeadingText),
                new WikiTextTokenDef("===", false, WikiTextToken.TokenType.Heading3Start, WikiTextTokenScopes.LineStart, x => x | WikiTextTokenScopes.HeadingText),
                new WikiTextTokenDef("===", false, WikiTextToken.TokenType.Heading3End, WikiTextTokenScopes.HeadingText, x => (x | WikiTextTokenScopes.HeadingSuffix) & ~WikiTextTokenScopes.HeadingText),
                new WikiTextTokenDef("====", false, WikiTextToken.TokenType.Heading4Start, WikiTextTokenScopes.LineStart, x => x | WikiTextTokenScopes.HeadingText),
                new WikiTextTokenDef("====", false, WikiTextToken.TokenType.Heading4End, WikiTextTokenScopes.HeadingText, x => (x | WikiTextTokenScopes.HeadingSuffix) & ~WikiTextTokenScopes.HeadingText),
                new WikiTextTokenDef("=====", false, WikiTextToken.TokenType.Heading5Start, WikiTextTokenScopes.LineStart, x => x | WikiTextTokenScopes.HeadingText),
                new WikiTextTokenDef("=====", false, WikiTextToken.TokenType.Heading5End, WikiTextTokenScopes.HeadingText, x => (x | WikiTextTokenScopes.HeadingSuffix) & ~WikiTextTokenScopes.HeadingText),
                new WikiTextTokenDef("======", false, WikiTextToken.TokenType.Heading6Start, WikiTextTokenScopes.LineStart, x => x | WikiTextTokenScopes.HeadingText),
                new WikiTextTokenDef("======", false, WikiTextToken.TokenType.Heading6End, WikiTextTokenScopes.HeadingText, x => (x | WikiTextTokenScopes.HeadingSuffix) & ~WikiTextTokenScopes.HeadingText),
                new WikiTextTokenDef("#", false, WikiTextToken.TokenType.HeadingAnchor, WikiTextTokenScopes.HeadingSuffix),
