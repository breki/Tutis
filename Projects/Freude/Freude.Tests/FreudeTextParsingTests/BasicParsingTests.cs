...
par 2 line 2 ");
        ...
        public void DoubleImagesDoc()
        {
            ...
            AssertElement<ImageElement>(par, 0, x => Assert.AreEqual ("http://www.arso.gov.si/vreme/napovedi in podatki/radar_anim.gif", x.ImageUrl.ToString()));
            AssertElement<ImageElement>(par, 1, x => Assert.AreEqual ("http://google.com/test.png", x.ImageUrl.ToString()));
        }
        ...
        public void ImageWithTextAround()
        {
            ...
            AssertElement<ImageElement>(par, 1, x => Assert.AreEqual ("http://www.arso.gov.si/vreme/napovedi in podatki/radar_anim.gif", x.ImageUrl.ToString()));
