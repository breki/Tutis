...
namespace NewDock
{
	...
	{
	    public override DockPaneStripTabBase CreateTab(IDockContent content)
        {
            return new VS2005DockPaneStripTab(content);
        }
        ...
        private static Bitmap ImageButtonClose
        {
            get
            {
                if (imageButtonClose == null)
                    imageButtonClose = Resources.DockPane_Close;

                return imageButtonClose;
            }
        }

        private VS2005DockPaneStripInertButton buttonClose;
        private VS2005DockPaneStripInertButton ButtonClose
        {
            get
            {
                if (buttonClose == null)
                {
                    buttonClose = new VS2005DockPaneStripInertButton(ImageButtonClose, ImageButtonClose);
                    toolTip.SetToolTip(buttonClose, ToolTipClose);
        ...
        private static Bitmap ImageButtonWindowList
        {
            get
            {
                if (imageButtonWindowList == null)
                    imageButtonWindowList = Resources.DockPane_Option;

                return imageButtonWindowList;
            }
        }
        ...
        private static Bitmap ImageButtonWindowListOverflow
        {
            get
            {
                if (imageButtonWindowListOverflow == null)
                    imageButtonWindowListOverflow = Resources.DockPane_OptionOverflow;

                return imageButtonWindowListOverflow;
            }
        }

        private VS2005DockPaneStripInertButton m_buttonWindowList;
        private VS2005DockPaneStripInertButton ButtonWindowList
        {
            get
            {
                if (m_buttonWindowList == null)
                {
                    m_buttonWindowList = new VS2005DockPaneStripInertButton(ImageButtonWindowList, ImageButtonWindowListOverflow);
                    toolTip.SetToolTip(m_buttonWindowList, ToolTipSelect);
		...
		{
			if (Appearance == DockPaneAppearanceStyle.ToolWindow)
		...
		protected override void OnPaint(PaintEventArgs e)
		{
            ...
            if (Appearance == DockPaneAppearanceStyle.Document)
            {
			...
			base.OnPaint (e);
			CalculateTabs();
            if (Appearance == DockPaneAppearanceStyle.Document && DockPane.ActiveContent != null)
            {
		...
		private void CalculateTabs_ToolWindow()
		{
            ...
            foreach (VS2005DockPaneStripTab tab in Tabs)
            {
        ...
        private bool CalculateDocumentTab(Rectangle rectTabStrip, ref int x, int index)
        {
            ...
            VS2005DockPaneStripTab tab = Tabs[index] as VS2005DockPaneStripTab;
		...
		private void CalculateTabs_Document()
		{
            ...
            {
                int tempX = x;
                VS2005DockPaneStripTab tab = Tabs[m_startDisplayingTab] as VS2005DockPaneStripTab;
        ...
        public override void EnsureTabVisible(IDockContent content)
		{
            if (Appearance != DockPaneAppearanceStyle.Document || !Tabs.Contains(content))
                return;
		...
		private void DrawTabStrip_Document(Graphics g)
		{
            ...
            VS2005DockPaneStripTab tabActive = null;
			...
			for (int i=0; i<count; i++)
			{
                ...
                {
                    tabActive = Tabs[i] as VS2005DockPaneStripTab;
                    continue;
                }
				if (rectTab.IntersectsWith(rectTabOnly))
					DrawTab(g, Tabs[i] as VS2005DockPaneStripTab, rectTab);
			}
		...
		private void DrawTabStrip_ToolWindow(Graphics g)
		{
			...
			for (int i=0; i<Tabs.Count; i++)
				DrawTab(g, Tabs[i] as VS2005DockPaneStripTab, GetTabRectangle(i));
		}
		...
		private Rectangle GetTabRectangle_ToolWindow(int index)
		{
			...
			VS2005DockPaneStripTab tab = (VS2005DockPaneStripTab)(Tabs[index]);
        ...
        private void DrawTab(Graphics g, VS2005DockPaneStripTab tab, Rectangle rect)
		{
			if (Appearance == DockPaneAppearanceStyle.ToolWindow)
		...
		private void DrawTab_ToolWindow(Graphics g, VS2005DockPaneStripTab tab, Rectangle rect)
		{
		...
		private void DrawTab_Document(Graphics g, VS2005DockPaneStripTab tab, Rectangle rect)
		{
            if (tab.TabWidth == 0)
                return;
		...
		private void SetInertButtons()
		{
            ...
            {
                if (buttonClose != null)
                    buttonClose.Left = -buttonClose.Width;
		...
		protected override void OnMouseHover(EventArgs e)
		{
			...
			if (this.toolTip.GetToolTip(this) != toolTip)
			{
